...
namespace OnlineStore.API.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            int pageSize = 12;
            var products = (categoryId == 0 ? _productService.GetAll().Data : _productService.GetAll(_ => _.CategoryId == categoryId).Data).OrderByDescending(_ => _.Id).ToList();
        ...
        public IActionResult Download()
        {
            ...
            byte[] excelFile = ExcelSheet(fileName, _productService.GetAllProductWithCategory().Data);
